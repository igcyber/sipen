                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-blue btn-icon"><i class="fas fa-pencil-alt"></i></button>
                                                    <button class="btn btn-red btn-icon"><i class="fas fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
